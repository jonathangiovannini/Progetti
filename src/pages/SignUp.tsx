            ...
            <div className="max-w-2xl w-full space-y-6">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-mine-shaft-200 p-6 space-y-4">
                    ...
                    <div className="flex items-start gap-2 pt-2">
                        ...
                        />
                        <label htmlFor="terms" className="text-sm text-mine-shaft-600 cursor-pointer">
                            Accetto i{' '}
                            <a href="#" className="text-mine-shaft-950 hover:underline font-medium">
                ...
                <p className="text-center text-sm text-mine-shaft-600 mb-8">
                    Hai già un account?{' '}
                    <a href="/login" className="font-medium text-mine-shaft-950 hover:underline">
                        Accedi
                    </a>
                </p>
            </div>
